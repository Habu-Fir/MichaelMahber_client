...
//                     <button
//                         onClick={() => window.location.href = '/loans/request'}
//                         className="px-4 py-2 bg-linear-to-r from-amber-500 to-yellow-600 text-white rounded-lg hover:from-amber-600 hover:to-yellow-700 transition-all font-medium shadow-md"
//                     >
//                         Apply for Loan
//                     </button>
//                     <button
