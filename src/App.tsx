...
// ===== IMPORT CONTRIBUTION PAGES =====
import MyContributions from './pages/contributions/MyContributions';
import AllContributions from './pages/contributions/AllContributions';
      ...
      <AuthProvider>
        <Routes>
          ...
          >
            ...
            {/* ===== CONTRIBUTION ROUTES ===== */}
            {/* Members view their own contributions */}
            <Route path="my-contributions" element={<MyContributions />} />
            {/* Admins manage all contributions */}
            <Route path="contributions" element={<AllContributions />} />
